    ...
    class UngroupElementCommand {
        ...
        async execute() {
            ...
            if (this.isReGroup) {
                ...
                const isMicroDapps = ((_j = (_h = this.data) === null || _h === void 0 ? void 0 : _h.module) === null || _j === void 0 ? void 0 : _j.category) === 'micro-dapps';
                const newElData = {
                    id: this.data.id,
                ...
                this.dropRow.toggleUI(!!((_k = dropSectionData === null || dropSectionData === void 0 ? void 0 : dropSectionData.elements) === null || _k === void 0 ? void 0 : _k.length));
            }
        }
        async undo() {
        ...
        initEventListeners() {
            ...
            this.addEventListener('drop', async function (event) {
                ...
                if (nearestFixedItem) {
                    ...
                    // ungrouping elm
                    if (isUngrouping) {
                        const dragCmd = new index_41.UngroupElementCommand(self.currentToolbar, nearestFixedItem, config, false);
                    ...
                    if (dropElm && !inEmptyPnl) {
                        ...
                        if (dropElm.classList.contains('bottom-block') || collision.mergeSide == "bottom") {
                            if (isUngrouping) {
                                ...
                                const dragCmd = new index_41.UngroupElementCommand(self.currentToolbar, dropElement, config, true, true);
                                index_41.commandHistory.execute(dragCmd);
                                self.currentElement.opacity = 1;
                                resetDragTarget();
                            }
                            ...
                            if (isUngrouping) {
                                const dropElement = eventTarget;
                                const dragCmd = new index_41.UngroupElementCommand(self.currentToolbar, dropElement, config, true, false);
                                index_41.commandHistory.execute(dragCmd);
                                self.currentElement.opacity = 1;
                                resetDragTarget();
                            }
                        ...
                        if (elementConfig) {
                            ...
                            if (isUngrouping) {
                                const dropElement = eventTarget;
                                const dragCmd = new index_41.UngroupElementCommand(self.currentToolbar, dropElement, config, false);
                                index_41.commandHistory.execute(dragCmd);
                                self.currentElement.opacity = 1;
                                resetDragTarget();
                            }
        ...
        async onPrependRow(pageRow) {
            ...
            if (newPageRow) {
                const dragCmd = (0, index_40.getDragData)() ?
                    ...
                    this.isUngrouping() ?
                        new index_41.UngroupElementCommand(this.currentToolbar, newPageRow, config, false) :
