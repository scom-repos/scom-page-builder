        ...
        constructor(element, settings) {
            ...
            for (let row of rows) {
                ...
                try {
                    ...
                    this.rowsConfig[id] = JSON.stringify(Object.assign(Object.assign({}, this.oldSettings), parsedConfig));
                }
                catch (_a) { }
            }
        }
        ...
        initEventListeners() {
            ...
            this.addEventListener('dragstart', function (event) {
                ...
                if (eventTarget.id === 'sectionStack') {
                    (0, index_63.setDragData)({ module: { name: 'sectionStack', path: '' }, type: index_65.ElementType.PRIMITIVE });
