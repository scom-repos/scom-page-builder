            ...
            this.addEventListener('drop', async function (event) {
                ...
                if (nearestFixedItem) {
                    ...
                    if (dropElm) {
                        ...
                        if (isBottomBlock) {
                            const config = (0, index_39.getDragData)();
                            const dragCmd = new index_40.UpdateTypeCommand(dropElm, config ? null : self.currentElement, self.getNewElementData());
                            index_40.commandHistory.execute(dragCmd);
                        }
                        else {
                        ...
                        if (elementConfig) {
                            ...
                            const dragCmd = hasData && activedBlock ?
                                new index_40.AddElementCommand(self.getNewElementData(), activedBlock.classList.contains('back-block'), false, activedBlock) :
                                !hasData && new index_40.AddElementCommand(self.getNewElementData(), true, true, null, pageRow);
                            dragCmd && await index_40.commandHistory.execute(dragCmd);
                        }
                        else {
    ...
    let IDEToolbar = class IDEToolbar extends components_25.Module {
        ...
        async fetchModule(data) {
            ...
            if (this._readonly)
                return;
            try {
                const module = await (0, index_45.getEmbedElement)(((_a = data === null || data === void 0 ? void 0 : data.module) === null || _a === void 0 ? void 0 : _a.path) || '');
                if (!module)
