...
define("@scom/scom-page-builder/utility/index.ts", ["require", "exports", "@ijstech/components", "@ijstech/eth-wallet", "@scom/scom-page-builder/const/index.ts", "@scom/scom-page-builder/utility/pathToRegexp.ts"], function (require, exports, components_2, eth_wallet_1, index_1, pathToRegexp_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const getEmbedElement = async (path) => {
        ...
        const result = await components_2.application.loadScript(`libs/@scom/${path}/index.js`);
...
define("@scom/scom-page-builder/command/add.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/const/index.ts", "@scom/scom-page-builder/store/index.ts"], function (require, exports, components_3, index_2, index_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ElementCommand {
        ...
        execute() {
            ...
            if (this.isDeleted) {
                ...
                index_3.pageObject.addRow(this.data, this.rowId);
            }
        }
        undo() {
            if (this.isDeleted) {
...
define("@scom/scom-page-builder/command/updateColor.ts", ["require", "exports", "@scom/scom-page-builder/store/index.ts"], function (require, exports, index_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UpdateColorCommand {
        ...
        execute() {
            ...
            index_4.pageObject.updateSection(id, { backgroundColor: this.color });
        }
        undo() {
            this.element.style.backgroundColor = this.oldColor;
            const id = this.element.id.replace('row-', '');
            index_4.pageObject.updateSection(id, { backgroundColor: this.oldColor });
        }
        redo() { }
    }
...
define("@scom/scom-page-builder/command/resize.ts", ["require", "exports", "@scom/scom-page-builder/store/index.ts", "@scom/scom-page-builder/command/interface.ts"], function (require, exports, index_5, interface_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        execute() {
            ...
            if (this.toolbar) {
                ...
                if (newColumnData.column !== this.oldDataColumn.column || newColumnData.columnSpan !== this.oldDataColumn.columnSpan)
                    index_5.pageObject.setElement(rowId, elementId, Object.assign({ tag }, newColumnData));
            }
        }
        undo() {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
            ...
            if (this.toolbar) {
                ...
                this.toolbar.setTag(tag);
                index_5.pageObject.setElement(rowId, elementId, Object.assign({ tag }, this.oldDataColumn));
            }
        }
        redo() { }
    }
...
define("@scom/scom-page-builder/command/dragElement.ts", ["require", "exports", "@scom/scom-page-builder/command/interface.ts", "@scom/scom-page-builder/store/index.ts"], function (require, exports, interface_2, index_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class DragElementCommand {
        ...
        updateColumnData(el, rowId, column, columnSpan) {
            ...
            index_6.pageObject.setElement(rowId, el.id, newColumnData);
        ...
        resetColumnData(el, rowId, column, columnSpan) {
            index_6.pageObject.setElement(rowId, el.id, { column, columnSpan });
        ...
        execute() {
            ...
            index_6.pageObject.setElement(elementRowId, this.element.id, Object.assign({}, newColumnData));
            if (!elementRow.isEqualNode(dropRow)) {
                index_6.pageObject.addElement(dropRowId, Object.assign(Object.assign({}, this.data), newColumnData));
                index_6.pageObject.removeElement(elementRowId, this.element.id);
            ...
            const elementSection = index_6.pageObject.getRow(elementRowId);
        ...
        undo() {
            ...
            const elementRow = this.element.closest('ide-row');
            const elementRowId = ((elementRow === null || elementRow === void 0 ? void 0 : elementRow.id) || '').replace('row-', '');
            index_6.pageObject.setElement(elementRowId, this.element.id, Object.assign({}, this.oldDataColumn));
            if (!this.oldDataRow)
                return;
            const oldElementRow = document.querySelector(`#row-${this.oldDataRow}`);
            if (oldElementRow && !elementRow.isEqualNode(oldElementRow)) {
                index_6.pageObject.addElement(this.oldDataRow, Object.assign(Object.assign({}, this.data), this.oldDataColumn));
                index_6.pageObject.removeElement(elementRowId, this.element.id);
            ...
            const oldElementSection = index_6.pageObject.getRow(this.oldDataRow);
...
define("@scom/scom-page-builder/command/removeToolbar.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/const/index.ts", "@scom/scom-page-builder/store/index.ts"], function (require, exports, components_4, index_7, index_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class RemoveToolbarCommand {
        constructor(element) {
            ...
            const section = JSON.parse(JSON.stringify(index_8.pageObject.getRow(this.rowId)));
        ...
        execute() {
            var _a, _b;
            index_8.pageObject.removeElement(this.rowId, this.elementId);
            this.element.remove();
            const section = index_8.pageObject.getRow(this.rowId);
            if (this.pageRow) {
            ...
            components_4.application.EventBus.dispatch(index_7.EVENT.ON_UPDATE_SECTIONS);
        }
        undo() {
            index_8.pageObject.addElement(this.rowId, this.data, this.sectionId, this.elementIndex);
            const section = index_8.pageObject.getRow(this.rowId);
...
define("@scom/scom-page-builder/command/updateType.ts", ["require", "exports", "@scom/scom-page-builder/store/index.ts", "@scom/scom-page-builder/utility/index.ts", "@scom/scom-page-builder/interface/index.ts"], function (require, exports, index_9, index_10, index_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class UpdateTypeCommand {
        constructor(element, dropElm) {
            ...
            this.oldDropData = JSON.parse(JSON.stringify(index_9.pageObject.getElement(dropRowId, dropSectionId)));
        }
        getElements() {
            var _a, _b;
            if (((_a = this.data) === null || _a === void 0 ? void 0 : _a.type) === index_11.ElementType.COMPOSITE)
        ...
        execute() {
            ...
            const dropSectionId = ((dropSection === null || dropSection === void 0 ? void 0 : dropSection.id) || '');
            const dropSectionData = index_9.pageObject.getElement(dropRowId, dropSectionId);
            const clonedDropSecData = JSON.parse(JSON.stringify(dropSectionData));
            if (!dropSectionId || !dropRowId || !dropSectionData)
                return;
            if ((clonedDropSecData === null || clonedDropSecData === void 0 ? void 0 : clonedDropSecData.type) === index_11.ElementType.COMPOSITE) {
                const elementIndex = dropSectionData.elements.findIndex(elm => elm.id === dropToolbarId);
                const elementList = this.getElements();
                for (let i = 0; i < elementList.length; i++) {
                    index_9.pageObject.addElement(dropRowId, elementList[i], dropSectionId, elementIndex + i + 1);
                }
            }
            else if ((clonedDropSecData === null || clonedDropSecData === void 0 ? void 0 : clonedDropSecData.type) === index_11.ElementType.PRIMITIVE) {
                const elementList = this.getElements();
                clonedDropSecData.id = index_10.generateUUID();
                index_9.pageObject.setElement(dropRowId, dropSectionId, {
                    type: index_11.ElementType.COMPOSITE,
                    elements: [clonedDropSecData, ...elementList]
                });
            }
            dropSection.setData(dropRowId, index_9.pageObject.getElement(dropRowId, dropSectionId));
            const elementRow = this.element.closest('ide-row');
            const elementRowId = ((elementRow === null || elementRow === void 0 ? void 0 : elementRow.id) || '').replace('row-', '');
        ...
        undo() {
            ...
            index_9.pageObject.setElement(dropRowId, this.oldDropData.id, this.oldDropData);
            const oldElementRow = document.querySelector(`#row-${this.oldDataRow}`);
            index_9.pageObject.addElement(this.oldDataRow, this.data);
            const oldElementSection = index_9.pageObject.getRow(this.oldDataRow);
            oldElementRow && (oldElementRow.visible = !!((_a = oldElementSection === null || oldElementSection === void 0 ? void 0 : oldElementSection.elements) === null || _a === void 0 ? void 0 : _a.length));
        }
        redo() { }
    }
...
define("@scom/scom-page-builder/page/pageHeader.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/command/index.ts", "@scom/scom-page-builder/theme/index.ts", "@scom/scom-page-builder/page/pageHeader.css.ts"], function (require, exports, components_8, index_12, index_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PageHeader = void 0;
    const Theme = index_13.currentTheme;
            ...
            this.iconList = [
                {
                    ...
                    onClick: () => index_12.commandHistory.undo()
                },
                {
                    name: 'redo',
                    tooltip: { content: 'Redo last action', placement: 'bottom' },
                    onClick: () => index_12.commandHistory.redo()
                },
                // {
                //   name: 'tablet',
...
define("@scom/scom-page-builder/page/pageSection.css.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_9, index_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/dialogs/confirmDialog.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/utility/index.ts", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_10, index_15, index_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/dialogs/loadingDialog.css.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_11, index_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/dialogs/loadingDialog.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/utility/index.ts", "@scom/scom-page-builder/dialogs/loadingDialog.css.ts"], function (require, exports, components_12, index_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/dialogs/rowSettingsDialog.css.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_13, index_19) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/dialogs/rowSettingsDialog.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/utility/index.ts", "@scom/scom-page-builder/theme/index.ts", "@scom/scom-page-builder/dialogs/rowSettingsDialog.css.ts"], function (require, exports, components_14, index_20, index_21) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/dialogs/pageBlockSettingsDialog.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/utility/index.ts"], function (require, exports, components_15, index_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/common/toolbar.css.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_16, index_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/common/toolbar.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/interface/index.ts", "@scom/scom-page-builder/store/index.ts", "@scom/scom-page-builder/utility/index.ts", "@scom/scom-page-builder/command/index.ts", "@scom/scom-page-builder/theme/index.ts", "@scom/scom-page-builder/common/toolbar.css.ts"], function (require, exports, components_17, index_24, index_25, index_26, index_27, index_28) {
    ...
    let IDEToolbar = class IDEToolbar extends components_17.Module {
            ...
            for (let i = 0; i < this.toolList.length; i++) {
                ...
                let elm = await components_17.Button.create({
                    ...
                    onClick: () => {
                        ...
                        if (index_26.isEmpty(tool.userInputDataSchema)) {
        ...
        isTexbox() {
            var _a, _b;
            return ((_b = (_a = this.data) === null || _a === void 0 ? void 0 : _a.module) === null || _b === void 0 ? void 0 : _b.name) === index_24.ELEMENT_NAME.TEXTBOX;
        }
        showToolbars() {
        ...
        async fetchModule(data) {
            ...
            if (this._readonly)
                return;
            try {
                const module = await index_26.getEmbedElement(((_a = data === null || data === void 0 ? void 0 : data.module) === null || _a === void 0 ? void 0 : _a.path) || '');
                if (!module)
        ...
        async setData(properties) {
            ...
            if (!this._component)
                return;
            index_25.pageObject.setElement(this.rowId, this.data.id, { properties });
        }
        async setTag(tag) {
            var _a, _b, _c, _d;
            if (!this._component)
        ...
        async setProperties(data) {
            ...
            if (this._component.setRootDir) {
                const rootDir = index_25.getRootDir();
...
define("@scom/scom-page-builder/common/dragger.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/command/index.ts"], function (require, exports, components_18, index_29) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ContainerDragger {
        ...
        mouseUpHandler(event) {
            ...
            if (dropElm && !this.target.isSameNode(dropElm)) {
                const moveRowCmd = new index_29.MoveElementCommand(this.target, dropElm, this.stack, this.dataList);
                index_29.commandHistory.execute(moveRowCmd);
            }
            this.isDragging = false;
        }
        resetTarget() {
...
define("@scom/scom-page-builder/common/collapse.css.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_19, index_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/page/pageFooter.css.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_22, index_35) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/page/pageFooter.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/assets.ts", "@scom/scom-page-builder/theme/index.ts", "@scom/scom-page-builder/page/pageFooter.css.ts"], function (require, exports, components_23, assets_1, index_36) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/page/pageRow.css.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_24, index_37) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/page/pageRow.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/const/index.ts", "@scom/scom-page-builder/store/index.ts", "@scom/scom-page-builder/command/index.ts", "@scom/scom-page-builder/page/pageRow.css.ts"], function (require, exports, components_25, index_38, index_39, index_40) {
    ...
    let PageRow = PageRow_1 = class PageRow extends components_25.Module {
        ...
        async onClone() {
            ...
            if (!rowData)
                return;
            components_25.application.EventBus.dispatch(index_38.EVENT.ON_CLONE, { rowData, id: this.id });
        }
        onDeleteRow() {
...
define("@scom/scom-page-builder/page/pageRows.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/page/pageSection.tsx", "@scom/scom-page-builder/page/pageRow.tsx", "@scom/scom-page-builder/page/pageFooter.tsx", "@scom/scom-page-builder/const/index.ts", "@scom/scom-page-builder/utility/index.ts", "@scom/scom-page-builder/command/index.ts", "@scom/scom-page-builder/store/index.ts", "@scom/scom-page-builder/theme/index.ts", "@scom/scom-page-builder/page/pageRows.css.ts"], function (require, exports, components_27, pageSection_1, pageRow_1, pageFooter_1, index_41, index_42, index_43, index_44, index_45) {
    ...
    let PageRows = class PageRows extends components_27.Module {
        ...
        initEventBus() {
            components_27.application.EventBus.register(this, index_41.EVENT.ON_CLONE, this.onClone);
        }
        _handleClick(event) {
            if (this._readonly)
                return super._handleClick(event, true);
...
define("@scom/scom-page-builder/page/pageSidebar.css.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_28, index_46) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/page/pageSidebar.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/store/index.ts", "@scom/scom-page-builder/const/index.ts", "@scom/scom-page-builder/interface/index.ts", "@scom/scom-page-builder/assets.ts", "@scom/scom-page-builder/page/pageSidebar.css.ts"], function (require, exports, components_29, index_47, index_48, index_49, assets_2) {
    ...
    let PageSidebar = class PageSidebar extends components_29.Module {
        ...
        async getPageBlocks() {
            let rootDir = index_47.getRootDir();
        ...
        onAddComponent(module, type) {
            components_29.application.EventBus.dispatch(index_48.EVENT.ON_ADD_ELEMENT, { type, module });
        }
...
define("@scom/scom-page-builder/builder/builderHeader.css.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_30, index_50) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder/builder/builderHeader.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/assets.ts", "@scom/scom-page-builder/const/index.ts", "@scom/scom-page-builder/interface/index.ts", "@scom/scom-page-builder/store/index.ts", "@scom/scom-page-builder/utility/index.ts", "@scom/scom-page-builder/theme/index.ts", "@scom/scom-page-builder/builder/builderHeader.css.ts"], function (require, exports, components_31, assets_3, index_51, index_52, index_53, index_54, index_55) {
    ...
    let BuilderHeader = class BuilderHeader extends components_31.Module {
        ...
        initEventBus() {
            components_31.application.EventBus.register(this, index_51.EVENT.ON_UPDATE_SECTIONS, async () => {
                this.updateHeader();
            });
        }
        async setData(value) {
...
define("@scom/scom-page-builder/builder/builderFooter.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/const/index.ts", "@scom/scom-page-builder/interface/index.ts", "@scom/scom-page-builder/utility/index.ts", "@scom/scom-page-builder/store/index.ts", "@scom/scom-page-builder/theme/index.ts", "@scom/scom-page-builder/builder/builderFooter.css.ts"], function (require, exports, components_33, index_56, index_57, index_58, index_59, index_60) {
    ...
    let BuilderFooter = class BuilderFooter extends components_33.Module {
        ...
        initEventBus() {
            components_33.application.EventBus.register(this, index_56.EVENT.ON_UPDATE_SECTIONS, async () => {
        ...
        async updateFooter() {
            ...
            components_33.application.EventBus.dispatch(index_56.EVENT.ON_UPDATE_FOOTER);
        }
        addFooter() {
...
define("@scom/scom-page-builder/index.css.ts", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/theme/index.ts"], function (require, exports, components_34, index_61) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/scom-page-builder", ["require", "exports", "@ijstech/components", "@scom/scom-page-builder/const/index.ts", "@scom/scom-page-builder/store/index.ts", "@scom/scom-page-builder/theme/index.ts", "@scom/scom-page-builder/utility/index.ts", "@scom/scom-page-builder/store/index.ts", "@scom/scom-page-builder/index.css.ts"], function (require, exports, components_35, index_62, index_63, index_64, index_65, index_66) {
    ...
    let Editor = class Editor extends components_35.Module {
        ...
        setRootDir(value) {
            index_66.setRootDir(value);
        }
        getData() {
            return {
                header: index_63.pageObject.header,
                sections: index_63.pageObject.sections.filter(section => section.elements && section.elements.length),
                footer: index_63.pageObject.footer
            };
        }
        async setData(value) {
            index_63.pageObject.header = value.header;
            index_63.pageObject.sections = value.sections;
            index_63.pageObject.footer = value.footer;
            try {
        ...
        initEventBus() {
            components_35.application.EventBus.register(this, index_62.EVENT.ON_ADD_ELEMENT, (data) => {
                if (!data)
                    return;
                this.onAddRow(data);
            });
            components_35.application.EventBus.register(this, index_62.EVENT.ON_UPDATE_SECTIONS, async () => { });
            components_35.application.EventBus.register(this, index_62.EVENT.ON_UPDATE_FOOTER, async () => this.onUpdateWrapper());
        }
        async onAddRow(data) {
            const { type, module } = data;
            let element = {
                id: index_65.generateUUID(),
                column: 1,
            ...
            let rowData = {
                id: index_65.generateUUID(),
                row: index_63.pageObject.sections.length + 1,
                elements: [element]
            };
            if (module.path === 'scom-nft-minter' || module.path === 'scom-gem-token') {
                element.module = index_63.getDappContainer();
